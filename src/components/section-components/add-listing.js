                        ...
                        <div className="col-lg-12">
                            <div className="ltn__appointment-inner">
                                <form action="#">
                                    ...
                                    <p>
                                        <small>
                                            These fields are mandatory: Title,
                                            Property Media
                                        </small>
                                    </p>
                                    ...
                                    <p>
                                        <small>
                                            * At least 1 image is required for a
                                            valid submission.Minimum size is
                                            500/500px.
                                        </small>
                                        <br />
                                        <small>
                                            * PDF files upload supported as
                                            well.
                                        </small>
                                        <br />
                                        <small>
                                            * Images might take longer to be
                                            processed.
                                        </small>
                                    </p>
                                    <h6>Video Option</h6>
                                    ...
                                    >
                                        ...
                                        requested may not be available. We will
                                        contact you to confirm your actual
                                        appointment details.
                                    </div>
